...
class parallel_env(ParallelEnv):
    ...
    def observe(self):
        ...
        self.observations = {
            self.agents[0]: np.array([pos_A[0], pos_A[1], pos_B[0], pos_B[1], ball_poss], dtype=np.int32),
            self.agents[1]: np.array([pos_B[0], pos_B[1], pos_A[0], pos_A[1], ball_poss], dtype=np.int32),
        }
